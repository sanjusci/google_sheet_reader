...
class BaseConfig(object):
    ...
    SMTP_CONFIG = {
        ...
        'MAIL_USE_TLS': False,
        'MAIL_USE_SSL': True,
        'MAIL_FROM_USER': os.environ.get('MAIL_FROM_USER', '!Test Services Team'),
        'MAIL_FROM_EMAIL': os.environ.get('MAIL_FROM_EMAIL', 'tets@gmail.com'),
        'MAIL_USERNAME': os.environ.get('MAIL_USERNAME', 'test@gmail.com'),
        'MAIL_PASSWORD': os.environ.get('MAIL_PASSWORD', 'test123'),
